...
# Custom Logger to redirect print() statements to both Terminal and Web Page
class SocketLogger:
...
# Read tokens securely from Render Environment Variables
...
<body>
    ...
    <script>
        ...
        socket.on('log_message', function(msg) {
            ...
            item.textContent = "[" + new Date().toLocaleTimeString() + "] " + msg.data;
...
# Start the background Google Sheets loop inside a separate thread
